...
ALTER TABLE NewBook
	ADD CONSTRAINT Book_Publisher FOREIGN KEY (pubname) REFERENCES NewPublisher(pubname)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE NewOrder
	ADD CONSTRAINT Ord_Book FOREIGN KEY (bookid) REFERENCES NewBook(bookid)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
...
ALTER TABLE NewOrder
	ADD CONSTRAINT Ord_Customer FOREIGN KEY (custid) REFERENCES NewCustomer(custid)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
